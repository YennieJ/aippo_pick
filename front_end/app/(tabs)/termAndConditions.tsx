...
1. 개인정보 처리방침 개요
본 앱은 회원가입 및 로그인을 요구하지 않으며, 공모주 관련 정보 및 알림 제공을 위한 정보 서비스입니다.

2. 수집하는 개인정보 항목
본 앱은 기본적으로 개인정보를 수집하지 않으나, 서비스 제공을 위해 아래 정보가 수집·처리될 수 있습니다.
- 기기 또는 기타 ID (예: Firebase Cloud Messaging(FCM) 푸시 알림 토큰, 앱 설치 식별자)
- 앱 상호작용 정보 (알림 설정, 화면 이동 등)
- 비정상 종료 로그 (오류 분석 목적)
- 즐겨찾기 및 최근 본 목록 (사용자 편의 기능 제공, 로컬 저장)
...
4. 개인정보 보관 및 이용 기간
- 로컬 저장 데이터(즐겨찾기, 최근 본 목록 등)는 이용자가 앱 데이터를 삭제하거나 앱을 삭제할 경우 삭제될 수 있습니다.
- 푸시 알림 제공을 위해 서버에 저장되는 정보(FCM 토큰, 알림 설정 등)는 서비스 운영에 필요한 기간 동안 보관되며, 이용자가 앱 삭제 또는 앱 데이터 삭제를 수행할 경우 삭제될 수 있습니다.
...
현재 본 앱은 개인정보 처리 업무를 외부에 위탁하지 않으며, 개인정보의 국외 이전이 발생하지 않도록 노력합니다.
다만, 서비스 제공을 위해 필요한 경우 관련 사항을 사전에 고지합니다.

7. 이용자의 권리 및 행사 방법
이용자는 앱 내 알림 설정 해제, 앱 삭제 또는 기기 내 앱 데이터 삭제를 통해 저장된 정보를 삭제할 수 있습니다.
서비스 제공 방식에 따라 별도의 개인정보 삭제 요청 절차는 제공되지 않을 수 있습니다.
